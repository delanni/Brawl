...
~~~sh
# getting the code
git clone git@github.com:nko4/madison-ivy.git && cd ./madison-ivy/

# developing
npm install
npm start

# deploying (to http://madison-ivy.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@madison-ivy.2013.nodeknockout.com
ssh root@madison-ivy.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@madison-ivy.2013.nodeknockout.com
ssh -i ./id_deploy root@madison-ivy.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/madison-ivy" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
